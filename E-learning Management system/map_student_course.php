<!DOCTYPE html>
<head>
<title>Map Student to the course </title>
...
<body>
    ...
    <div class="box">
        <h1>Map Student to courses</h1>
        <form name="myform"  action="insert_student_course.php" method="POST" >
            <p>Student ID</p>
            <select>
                <option>-- Select Student ID --</option>
                <?php echo $options;?>
            </select>
            <input type="text" name="sacid" placeholder="Enter Student ID " required="">
            <p>Course ID</p>
            <select>
