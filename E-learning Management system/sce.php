...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card w3-xlarge" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      <a href="schangepswd.html" class="w3-bar-item w3-button"><i class="material-icons">published_with_changes</i> Change Password</a>
...
<div class="w3-sidebar w3-dark-grey w3-bar-block w3-xlarge" style="width:15%">
    ...
    <a href="sce.php" class="w3-bar-item w3-button w3-blue" ><i class="material-icons">auto_stories</i> My Courses</a>
...
<?php
      ...
      $SELECT = "SELECT sid From slogin Where sname = ?";
          
      $stmt = $conn->prepare($SELECT);
      $stmt->bind_param("s",$name);
      $stmt->execute();
      $result = $stmt->get_result(); 
      $sacid = $result->fetch_assoc();
      $sid = implode("",$sacid);

      if($result->num_rows!=0)
      {

      $sql="SELECT * from scourses where sid= '$sid' ";
