...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card w3-xlarge" id="myNavbar">
    ...
    <span class="w3-bar-item w3-xxlarge "> FACULTY DASHBOARD </span>
...
<div class="w3-sidebar w3-dark-grey w3-bar-block w3-xlarge" style="width:15%">
    ...
    <a href="fd.php" class="w3-bar-item w3-button w3-blue" ><i class="material-icons">book</i> Courses</a>
    <a href="fce.php" class="w3-bar-item w3-button" ><i class="material-icons">auto_stories</i> My courses</a>
